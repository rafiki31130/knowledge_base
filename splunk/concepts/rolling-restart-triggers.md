> 🇬🇧 English version: [EN/rolling-restart-triggers.md](r_knowledge_base_pro/splunk/concepts/EN/rolling-restart-triggers.md)
...
- [Cheat-sheet admin Splunk](splunk-admin.md) — commandes,
