...
- En cas d'urgence avec `allowSkipReplication=true` activé pour débloquer : documenter le créneau (date, raison) et planifier le retour à `false` dès l'incident clos.
